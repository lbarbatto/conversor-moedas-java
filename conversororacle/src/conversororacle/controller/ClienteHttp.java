...
public class ClienteHttp {
	...
	public String getConversao(String to, String from, double amount, int index) throws IOException, InterruptedException {
	...
	public Object getCambio() {
		...
		HttpClient httpClient = HttpClient.newBuilder()
				.build();
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create("https://v6.exchangerate-api.com/v6/21148923d911b719191c2ccf/latest/brl"))
				.GET()
				.build();
